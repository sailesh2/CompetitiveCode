...
int main()
{
    ...
    for(i=0;i<q;i++)
    {
        ...
        while(1)
        {
            while(save+ctr<n && brr[save+ctr]<=l)
            {
                save2=save+ctr;
                ctr=ctr*2;
            }
        ...
        if(brr[save]==l)
        {
            has.insert(make_pair(make_pair(brr[save],k),i+1));
        query[brr[save]].push_back(k);
            st.insert(brr[save]);
        }
        else
        {

            has.insert(make_pair(make_pair(brr[save+1],k),i+1));
        query[brr[save+1]].push_back(k);
        st.insert(brr[save+1]);
        }
